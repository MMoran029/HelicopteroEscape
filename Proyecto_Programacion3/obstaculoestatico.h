...
public:
    ...
    ObstaculoEstatico(qreal posX, qreal posY, qreal alto, int variante, int nivel);
    ...
    static qreal calcularAncho(qreal alto, int variante, int nivel);
...
private:
    QPixmap imagen;
    Civil *civilAsociado;
    static QPixmap obtenerImagen(int variante, int nivel);
};
