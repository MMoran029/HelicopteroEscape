...
void PantallaMisiones::configurarElementos(){
    ...
    connect(botonMisionExtra, &QPushButton::clicked, this, &PantallaMisiones::misionExtraPresionado);
...
void PantallaMisiones::acomodarElementos(){
    ...
    int posY = (height() - botonMision1->height()) / 2 - 30;
    ...
    int posXExtra = (width() - botonMisionExtra->width()) / 2;
    int posYExtra = posY + botonMision1->height() + 20;
    botonMisionExtra->move(posXExtra, posYExtra);
